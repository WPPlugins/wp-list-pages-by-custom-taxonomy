...
define( "PBYTAX_VERSION", "1.4.6" );
define( "PBYTAX_TEMPLATE_VERSION", "1.4.3" );
...
class Pages_by_Tax extends WP_Widget {	
	...
	public function widget( $args, $instance ) {
		...
		if ( 131 <= intval($template_version) ){
	...
	public function form( $instance ) {
        ...
        <div class="pbytax-settings">
            ...
            <p>
                ...
                <br/>
                <input type="checkbox" class="checkbox-margin" value="true" name="<?php echo $this->get_field_name( 'title_no_wrap' ); ?>" <?php if($title_no_wrap=="true"){ echo "checked"; } ?> > <?php _e( 'Hide Post Title if overflowing one line', 'wp-list-pages-by-custom-taxonomy' ); ?>
             </p>
